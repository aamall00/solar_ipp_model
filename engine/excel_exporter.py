...
def _sheet_income_statement(wb, results, compiled) -> None:
    ...
    sections = [
        ...
        {"type": "row", "label": "EBIT",             "array": _get("tax_block.ebit"),           "unit": "INR Lakhs", "fmt": FMT_LAKHS, "bold": True,
         "label_fill": C_SECTION_ALT},
        {"type": "row", "label": "Interest Expense", "array": _get("debt_service_block.interest_payment"), "unit": "INR Lakhs", "fmt": FMT_LAKHS, "indent": 1},
        {"type": "row", "label": "PBT",              "array": _get("tax_block.pbt"),            "unit": "INR Lakhs", "fmt": FMT_LAKHS, "bold": True,
         "label_fill": C_SECTION_ALT},
        {"type": "row", "label": "Tax",              "array": _get("tax_block.tax"),            "unit": "INR Lakhs", "fmt": FMT_LAKHS, "indent": 1},
        {"type": "row", "label": "PAT  (PBT − Tax)", "array": _get("tax_block.pbt") - _get("tax_block.tax"),
...
def _sheet_cashflow(wb, results, compiled) -> None:
    ...
    sections = [
        ...
        {"type": "row", "label": "EBITDA",                 "array": _get("cashflow_block.ebitda"),         "unit": "INR Lakhs", "fmt": FMT_LAKHS, "bold": True},
        {"type": "row", "label": "Tax Paid",               "array": -_get("tax_block.tax"),                "unit": "INR Lakhs", "fmt": FMT_LAKHS, "indent": 1},
        ...
        {"type": "row", "label": "Equity Invested  (−ve)",  "array": _get("returns_block.equity_invested"), "unit": "INR Lakhs", "fmt": FMT_LAKHS, "indent": 1},
        {"type": "row", "label": "Equity Cashflow",         "array": _get("returns_block.equity_cashflow"), "unit": "INR Lakhs", "fmt": FMT_LAKHS, "bold": True},
        {"type": "row", "label": "Project Cashflow",        "array": _get("returns_block.project_cashflow"),"unit": "INR Lakhs", "fmt": FMT_LAKHS, "bold": True},
        {"type": "blank"},
...
def _sheet_debt_schedule(wb, results, compiled) -> None:
    ...
    sections = [
        ...
        {"type": "row", "label": "Total Project Cost",  "array": _get("debt_sizing_block.total_project_cost"), "unit": "INR Lakhs", "fmt": FMT_LAKHS, "bold": True},
        {"type": "row", "label": "Debt Amount",         "array": _get("debt_sizing_block.debt_amount"),        "unit": "INR Lakhs", "fmt": FMT_LAKHS, "indent": 1},
        {"type": "row", "label": "Equity Amount",       "array": _get("debt_sizing_block.equity_amount"),      "unit": "INR Lakhs", "fmt": FMT_LAKHS, "indent": 1},
        {"type": "blank"},
